...
// Saca el nombre a partir del email
// "carlos.sosa@algo.com" -> "Carlos"
// "carla@algo.com"       -> "Carla"
function getNameFromEmail(email) {
  if (!email) return "";

  // Lo que está antes del @
  const beforeAt = email.split("@")[0];

  // Si tiene punto, me quedo con lo de antes del primer punto
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // (Opcional) cerrar offcanvas clickeando fuera
  document.addEventListener("click", (e) => {
    if (
      menuOffcanvas &&
