...
document.addEventListener("DOMContentLoaded", () => {
  // ====== ELEMENTOS DEL HEADER / MENÚ USUARIO ======
  ...
  // ====== CARRITO (VERSIÓN INDEX) ======
  const cartBtn      = document.getElementById("cartBtn");
  const cartOverlay  = document.getElementById("cartOverlay");
  const cartPanel    = document.getElementById("cartPanel");
  const cartCloseBtn = document.getElementById("cartCloseBtn");

  // ====== FORMULARIO PERFIL (SOLO EXISTE EN perfil.html) ======
  ...
  // Rellena el formulario de perfil SI existe (solo en perfil.html)
  function rellenarFormularioPerfil(cliente) {
    ...
    // Por seguridad, la contraseña NO se trae de la BD
    if (perfilPassInput) {
      perfilPassInput.value = "";
    }
  }

  // Trae el cliente logueado y actualiza header + formulario perfil
